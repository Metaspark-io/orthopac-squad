...
export default {
  SM: {
    ...
    quote: `"What would you rather your orthopedic surgeon do: fill out forms, or heal people?"`,
  ...
  SS: {
    ...
    image: ss,
    intro: 'From head & shoulders to knees & toes, the Man of Métier fights to protect the house of orthopaedics. Super Specialty knows that the key to ensuring that our workers, communities, and economy remain healthy is to preserve pure, unencumbered access to orthopaedic care.',
    ...
    randomFact: 'Every day, orthopaedic surgeons help people regain lost mobility and return to a more productive, higher quality of life.',
