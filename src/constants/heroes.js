...
export default {
  ...
  LL: {
    name: 'Lady Ligament',
    image: ll,
    intro: 'Stretching PAC contributions is this lady’s game! As the co-leader of the OrthoPac squad. She raises funds from specialty and group practices, using corporate dollars to expand the AAOS presence and political footprint.',
