    ...
    return (
      <div className="container-fluid py-2 bg-light sticky-top">
        <nav className="nav nav-pills nav-fill">
          <a className="nav-item nav-link" activeClassName="active" href="/#issues">The Issues</a>
          <a className="nav-item nav-link" activeClassName="active" href="/#heroes">The Heroes</a>
